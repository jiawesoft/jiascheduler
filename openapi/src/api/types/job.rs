...
pub struct SaveScheduleReq {
    ...
    pub eid: String,
    pub args: Option<serde_json::Value>,
    pub timer_expr: Option<CustomTimerExpr>,
    pub restart_interval: Option<u64>,
}
...
impl Into<logic::types::CustomTimerExpr> for CustomTimerExpr {
    fn into(self) -> logic::types::CustomTimerExpr {
        logic::types::CustomTimerExpr {
...
impl From<String> for TimerExpr {
    fn from(value: String) -> Self {
        if is_valid_json!(&value) {
            let v = serde_json::from_str::<logic::types::CustomTimerExpr>(&value).unwrap();
...
impl Into<logic::types::CustomTimerExpr> for TimerExpr {
    fn into(self) -> logic::types::CustomTimerExpr {
        logic::types::CustomTimerExpr {
            timezone: self.timezone,
            expr: format!(
